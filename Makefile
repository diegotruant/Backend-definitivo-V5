...
quality-gate: openapi
	$(PYTHON) -m pytest -q tests/pytest_chart_output_quality.py tests/pytest_product_output_quality.py tests/pytest_engine_output_quality.py tests/pytest_scientific_verification_core.py tests/pytest_golden_scientific.py tests/pytest_mmp_scientific_gate.py tests/pytest_mmp_orchestration_gate.py --tb=short
