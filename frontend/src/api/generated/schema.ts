...
export interface paths {
    ...
    "/coach/adherence": {
        ...
        get?: never;
        put?: never;
        /** Planned vs performed adherence analysis */
        post: operations["coachAdherence"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/coach/testing-plan": {
        ...
        get?: never;
        put?: never;
        /** Recommend priority calibration tests */
        post: operations["coachTestingPlan"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/coach/race-execution": {
        ...
        get?: never;
        put?: never;
        /** Race pacing, fueling and failure-mode plan */
        post: operations["coachRaceExecution"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/coach/equipment-comfort": {
        ...
        get?: never;
        put?: never;
        /** Equipment and comfort performance links */
        post: operations["coachEquipmentComfort"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/coach/female-athlete-context": {
        ...
        get?: never;
        put?: never;
        /** Optional female athlete context — not cycle-based prescription */
        post: operations["coachFemaleAthleteContext"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/coach/daily-brief": {
        ...
        get?: never;
        put?: never;
        /** Unified coach daily brief — attention, safety, PNEI, actions */
        post: operations["coachDailyBrief"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/coach/session-decision": {
        ...
        get?: never;
        put?: never;
        /** Planned session vs physiology and context layers */
        post: operations["coachSessionDecision"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        CoachDailyBriefRequest: {
            ...
            /**
             * Include Communication Draft
             * @default true
             */
            include_communication_draft: boolean;
        } & {
            [key: string]: unknown;
        };
        ...
        TwinStateBuildPayload: {
            ...
            /** Equipment Comfort Review */
            equipment_comfort_review?: {
                [key: string]: unknown;
            } | null;
            /** Female Athlete Context State */
            female_athlete_context_state?: {
                [key: string]: unknown;
            } | null;
            /** Female Athlete Context */
            female_athlete_context?: {
...
export interface operations {
    ...
    coachAdherence: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CoachAdherenceRequest"];
            };
        };
        responses: {
            /** @description Engine JSON payload — see docs/FRONTEND_DEVELOPER_GUIDE.md */
    ...
    coachTestingPlan: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CoachTestingPlanRequest"];
            };
        };
        responses: {
            /** @description Engine JSON payload — see docs/FRONTEND_DEVELOPER_GUIDE.md */
    ...
    coachEquipmentComfort: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CoachEquipmentComfortRequest"];
            };
        };
        responses: {
            /** @description Engine JSON payload — see docs/FRONTEND_DEVELOPER_GUIDE.md */
    ...
    coachFemaleAthleteContext: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CoachFemaleAthleteContextRequest"];
            };
        };
        responses: {
            /** @description Engine JSON payload — see docs/FRONTEND_DEVELOPER_GUIDE.md */
    ...
    coachDailyBrief: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CoachDailyBriefRequest"];
            };
        };
        responses: {
            /** @description Engine JSON payload — see docs/FRONTEND_DEVELOPER_GUIDE.md */
    ...
    coachSessionDecision: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CoachSessionDecisionRequest"];
            };
        };
        responses: {
            /** @description Engine JSON payload — see docs/FRONTEND_DEVELOPER_GUIDE.md */
