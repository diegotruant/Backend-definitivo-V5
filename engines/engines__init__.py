...
# analyze_rr_stream and calculate_dfa_alpha1 are re-exported lazily to break
# the circular import: hrv_engine → engines.hrv_dfa.analysis → engines/__init__
# → hrv_engine (partially initialised). The __getattr__ hook at the bottom handles
# attribute access on this package after the eager imports have completed.
...
# Lazy re-exports for names that would cause circular imports if imported eagerly.
_LAZY_EXPORTS = {
