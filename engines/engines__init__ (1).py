...
# analyze_rr_stream and calculate_dfa_alpha1 are re-exported lazily (see
# __getattr__ at the bottom) to break the circular import:
# hrv_engine → engines.hrv_dfa.analysis → engines/__init__ → hrv_engine
